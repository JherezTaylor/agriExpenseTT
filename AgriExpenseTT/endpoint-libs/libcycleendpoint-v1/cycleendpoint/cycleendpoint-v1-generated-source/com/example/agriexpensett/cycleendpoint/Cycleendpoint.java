...
public class Cycleendpoint extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
   ...
   * @return the request
   */
  public GetMatchingCycles getMatchingCycles(java.lang.String cropName, java.lang.Double start, java.lang.Double end, java.lang.String area) throws java.io.IOException {
    GetMatchingCycles result = new GetMatchingCycles(cropName, start, end, area);
    initialize(result);
    return result;
  }
  ...
  public class GetMatchingCycles extends CycleendpointRequest<com.example.agriexpensett.cycleendpoint.model.CycleCollection> {
    ...
    private static final String REST_PATH = "cyclecollection/{cropName}/{start}/{end}/{area}";
     ...
     * @since 1.13
     */
    protected GetMatchingCycles(java.lang.String cropName, java.lang.Double start, java.lang.Double end, java.lang.String area) {
      super(Cycleendpoint.this, "GET", REST_PATH, null, com.example.agriexpensett.cycleendpoint.model.CycleCollection.class);
    ...
    public GetMatchingCycles setArea(java.lang.String area) {
      this.area = area;
      return this;
    }
